...
Experiment code associated with the paper: [Airfoil Design Parameterization and Optimization using Bézier Generative Adversarial Networks](https://arxiv.org/pdf/xxxx.xxxxx.pdf)
